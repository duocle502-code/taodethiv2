...
export default function GeneratorView({ data, onSaveData }: GeneratorViewProps) {
  ...
  const handleGenerate = async () => {
    ...
    const mathRules = [
      ...
      '  Với d=15 (kích thước ký hiệu), vẽ: <path d="M {vx+d*uAx},{vy+d*uAy} L {vx+d*uAx+d*uBx},{vy+d*uAy+d*uBy} L {vx+d*uBx},{vy+d*uBy}" fill="none" stroke="#3B82F6" stroke-width="1.5"/>',
      '  Ví dụ: góc vuông tại B(80,230) với A(80,50) và C(280,230): uA=(0,-1), uB=(1,0) → <path d="M 80,215 L 95,215 L 95,230" fill="none" stroke="#3B82F6" stroke-width="1.5"/>',
